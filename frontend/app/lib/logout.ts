...
/**
 * Full sign-out: clears local state immediately, redirects to /login,
 * and fires a server-side cookie-clear in the background (fire-and-forget
 * so callers don't need to be async).
 */
